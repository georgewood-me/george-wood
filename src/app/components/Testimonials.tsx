    ...
    <section className="mt-16 -mx-4 relative">
      ...
      <div className="flex">
        <button
          ...
          className="glass-btn flex items-center justify-center w-[48px] h-[48px] hover:opacity-100 transition-opacity"
          style={{ borderTop: "none", borderLeft: "none", borderRadius: 0 }}
